...
#[test] fn text_hinting_options_all_options_comparison() { assert_eq!(render("tests/text/hinting-options/all-options-comparison"), 0); }
#[test] fn text_hinting_options_css_style_syntax() { assert_eq!(render("tests/text/hinting-options/css-style-syntax"), 0); }
#[test] fn text_hinting_options_eink_mono_clarity() { assert_eq!(render("tests/text/hinting-options/eink-mono-clarity"), 0); }
#[test] fn text_hinting_options_eink_mono_engine() { assert_eq!(render("tests/text/hinting-options/eink-mono-engine"), 0); }
#[test] fn text_hinting_options_eink_mono_target() { assert_eq!(render("tests/text/hinting-options/eink-mono-target"), 0); }
#[test] fn text_hinting_options_engine_auto() { assert_eq!(render("tests/text/hinting-options/engine-auto"), 0); }
#[test] fn text_hinting_options_engine_native() { assert_eq!(render("tests/text/hinting-options/engine-native"), 0); }
#[test] fn text_hinting_options_mode_lcd() { assert_eq!(render("tests/text/hinting-options/mode-lcd"), 0); }
#[test] fn text_hinting_options_mode_light() { assert_eq!(render("tests/text/hinting-options/mode-light"), 0); }
#[test] fn text_hinting_options_mode_vertical_lcd() { assert_eq!(render("tests/text/hinting-options/mode-vertical-lcd"), 0); }
#[test] fn text_hinting_options_mono_hinted_vs_unhinted() { assert_eq!(render("tests/text/hinting-options/mono-hinted-vs-unhinted"), 0); }
#[test] fn text_hinting_options_preserve_linear_metrics() { assert_eq!(render("tests/text/hinting-options/preserve-linear-metrics"), 0); }
#[test] fn text_hinting_options_symmetric_false() { assert_eq!(render("tests/text/hinting-options/symmetric-false"), 0); }
#[test] fn text_hinting_options_target_mono_1x() { assert_eq!(render("tests/text/hinting-options/target-mono-1x"), 0); }
#[test] fn text_hinting_options_target_mono() { assert_eq!(render("tests/text/hinting-options/target-mono"), 0); }
#[test] fn text_hinting_options_terminus_mono_clarity() { assert_eq!(render("tests/text/hinting-options/terminus-mono-clarity"), 0); }
#[test] fn text_hinting_options_terminus_mono_target() { assert_eq!(render("tests/text/hinting-options/terminus-mono-target"), 0); }
...
#[test] fn text_text_rendering_hinting_comparison() { assert_eq!(render("tests/text/text-rendering/hinting-comparison"), 0); }

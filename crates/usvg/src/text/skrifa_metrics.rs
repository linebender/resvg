...
//!
//! This module provides font metrics extraction using skrifa's MetadataProvider trait,
//! replacing the previous ttf-parser based implementation.

use std::num::NonZeroU16;

use fontdb::ID;
use skrifa::{
    FontRef, MetadataProvider, instance::LocationRef, instance::Size as SkrifaSize,
    raw::TableProvider,
};
...
pub(crate) fn load_font_metrics(data: &[u8], face_index: u32, id: ID) -> Option<ResolvedFont> {
...
pub(crate) fn has_char(data: &[u8], face_index: u32, c: char) -> bool {

...
use super::transform::{skrifa_to_tsp_tranform, tsp_to_skrifa_tranform};
...
fn paint_transform(outline_transform: Transform, transform: Transform) -> Transform {
    let outline_transform = skrifa_to_tsp_tranform(outline_transform);
    let gradient_transform = skrifa_to_tsp_tranform(transform);
    ...
    tsp_to_skrifa_tranform(gradient_transform)
}
